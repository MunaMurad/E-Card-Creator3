...
(window["webpackJsonp"] = window["webpackJsonp"] || []).push([["ui-components-header-fading-header-fading-module"], {
  ...
  /***/
  function node_modulesRawLoaderDistCjsJsSrcAppUiComponentsHeaderFadingHeaderFadingPageHtml(module, __webpack_exports__, __webpack_require__) {
    "use strict";
  ...
  /***/
  function srcAppUiComponentsHeaderFadingHeaderFadingRoutingModuleTs(module, __webpack_exports__, __webpack_require__) {
    "use strict";
    ...
    __webpack_require__.d(__webpack_exports__, "HeaderFadingPageRoutingModule", function () {
      return HeaderFadingPageRoutingModule;
    });
    /* harmony import */
    ...
    var _header_fading_page__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(
    /*! ./header-fading.page */
    ...
    var HeaderFadingPageRoutingModule = function HeaderFadingPageRoutingModule() {
      _classCallCheck(this, HeaderFadingPageRoutingModule);
    };

    HeaderFadingPageRoutingModule = tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["NgModule"])({
  ...
  /***/
  function srcAppUiComponentsHeaderFadingHeaderFadingModuleTs(module, __webpack_exports__, __webpack_require__) {
    "use strict";
    ...
    __webpack_require__.d(__webpack_exports__, "HeaderFadingPageModule", function () {
    ...
    var _header_fading_routing_module__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(
    /*! ./header-fading-routing.module */
    "./src/app/ui-components/header-fading/header-fading-routing.module.ts");
    /* harmony import */


    var _header_fading_page__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(
    /*! ./header-fading.page */
    "./src/app/ui-components/header-fading/header-fading.page.ts");

    var HeaderFadingPageModule = function HeaderFadingPageModule() {
      _classCallCheck(this, HeaderFadingPageModule);
    };

    HeaderFadingPageModule = tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["NgModule"])({
      imports: [_angular_common__WEBPACK_IMPORTED_MODULE_2__["CommonModule"], _angular_forms__WEBPACK_IMPORTED_MODULE_3__["FormsModule"], _ionic_angular__WEBPACK_IMPORTED_MODULE_4__["IonicModule"], _header_fading_routing_module__WEBPACK_IMPORTED_MODULE_5__["HeaderFadingPageRoutingModule"]],
  ...
  /***/
  function srcAppUiComponentsHeaderFadingHeaderFadingPageScss(module, __webpack_exports__, __webpack_require__) {
    "use strict";
  ...
  /***/
  function srcAppUiComponentsHeaderFadingHeaderFadingPageTs(module, __webpack_exports__, __webpack_require__) {
    "use strict";
    ...
    __webpack_require__.d(__webpack_exports__, "HeaderFadingPage", function () {
    ...
    var HeaderFadingPage = /*#__PURE__*/function () {
      function HeaderFadingPage() {
        _classCallCheck(this, HeaderFadingPage);
      ...
      _createClass(HeaderFadingPage, [{
        key: "ngOnInit",
        value: function ngOnInit() {} //********** scroll event  *************/
        ...
        value: function onScroll($event) {
          if ($event && $event.detail && $event.detail.scrollTop) {
            ...
            this.showToolbar = scrollTop >= 100; //console.log("showToolbar="+this.showToolbar);

            this.showTitle = scrollTop >= 100; //console.log("showTitle="+this.showTitle);
          } else {
            this.transition = false;
          }
        }
    ...
    HeaderFadingPage = tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["Component"])({
      selector: 'app-header-fading',
      template: tslib__WEBPACK_IMPORTED_MODULE_0__["__importDefault"](__webpack_require__(
      /*! raw-loader!./header-fading.page.html */
      "./node_modules/raw-loader/dist/cjs.js!./src/app/ui-components/header-fading/header-fading.page.html"))["default"],
      styles: [tslib__WEBPACK_IMPORTED_MODULE_0__["__importDefault"](__webpack_require__(
      /*! ./header-fading.page.scss */
      "./src/app/ui-components/header-fading/header-fading.page.scss"))["default"]]
    }), tslib__WEBPACK_IMPORTED_MODULE_0__["__metadata"]("design:paramtypes", [])], HeaderFadingPage);
    /***/
  }
}]);
//# sourceMappingURL=ui-components-header-fading-header-fading-module-es5.js.map