...
import { ShoppingAddressAddPage } from '../shopping-address-add/shopping-address-add.page';
import { ShoppingAddressEditPage } from '../shopping-address-edit/shopping-address-edit.page';
@Component({
  selector: 'app-shopping-checkout',
  templateUrl: './shopping-checkout.page.html',
  styleUrls: ['./shopping-checkout.page.scss'],
})
export class ShoppingCheckoutPage implements OnInit {
  //**** User authentication  ****/
  ...
  async addOrder() {
    ...
    this.shoppingService.placeOrder(this.selectAddressId, this.paymentType, this.orderItems, this.grandTotal)
      .then(
        () => {
